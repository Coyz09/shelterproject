...
import { newAdopter, clearErrors } from '../../actions/adopterActions'
import { NEW_ADOPTER_RESET } from '../../constants/adopterConstants'
...
const NewAdopter = () => {
    ...
    const {  error, success } = useSelector(state => state.newAdopter);
